...
keywords: 'MyHomeFarmer, AI agents, artificial intelligence, AI integration, automation, intelligent agents, AI features'
---
...
**Rule File**: `rule-MyHomeFarmer-generate-doc.mdc`
